...
<section class="container section_mt ">
    <div class="section_title_div">
        <h3>Introducing Smart <span>IOT & Telematics</span></h3>
    </div>
    <div class="index_about_div" data-aos="zoom-in" data-aos-delay="300">
        <p>E-Fill ev charging app & CMS are best suited for commercial & private charging stations. Our CMS helps you in
...
<section class="container section_mt ">
    <div class="section_title_div">
        <h3>Features of our <span>CMS</span></h3>
    </div>
        ...
        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12" data-aos="zoom-out" data-aos-duration="1000">
            <ul class="features_cms_ul">
                ...
                <li>
                    ...
                    <p> Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad, fuga doloremque laboriosam adipisci
                        nam non!</p>
                </li>
            </ul>
        </div>
